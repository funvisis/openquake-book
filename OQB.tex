...
% ------------------------------------------------------------------------- Part
\part{Hazard}
% new structure as proposed by DM
% ------------------------------------------------------------------------------
\chapter{Introduction}
	\input{./Part_Hazard/newStructure/intro.tex}
% ------------------------------------------------------------------------------
\chapter{Input Data Definition}
	\input{./Part_Hazard/newStructure/idDefinition.tex}
% ------------------------------------------------------------------------------
\chapter{The Logic Tree Processor}
	\input{./Part_Hazard/newStructure/ltProcessor.tex}
% ------------------------------------------------------------------------------
\chapter{The Earthquake Rupture Forecast Calculator}
	\input{./Part_Hazard/newStructure/erfCalculator.tex}	
% ------------------------------------------------------------------------------
\chapter{The Hazard Curve Calculator}
	\input{./Part_Hazard/newStructure/hcCalculator.tex}	
% ------------------------------------------------------------------------------
\chapter{The Stochastic Event Set Calculator}
	\input{./Part_Hazard/newStructure/sesCalculator.tex}	
% ------------------------------------------------------------------------------
\chapter{The Ground Motion Field Calculator}
	\input{./Part_Hazard/newStructure/gmfCalculator.tex}	
% ------------------------------------------------------------------------------
\chapter{Classical PSHA Analysis}
	\input{./Part_Hazard/newStructure/classicalPSHA.tex}	
% ------------------------------------------------------------------------------
\chapter{Event Based PSHA Analysis}
	\input{./Part_Hazard/newStructure/eventBasedPSHA.tex}	
% ------------------------------------------------------------------------------
\chapter{Deterministic Scenario Analysis}
	\input{./Part_Hazard/newStructure/deterministicScenario.tex}
% commented because new structure has been introduced
\begin{comment}
% ------------------------------------------------------------------------------
\chapter{Introduction}
