\gls{psha}, a methodology largely founded on the works of 
...
PSHA input models (e.g. the UCERF2 model, \citet{field2009}) and the one 
used for large areas (e.g. continents or large nations); both of them 
