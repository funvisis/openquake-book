...
\begin{center}
\subfigure[]{
\includegraphics[width=6cm]{./Figures/Part_Hazard/uncorrelatedGmfTabasPGA.eps}}
\subfigure[]{
\includegraphics[width=6cm]{./Figures/Part_Hazard/correlatedGmfTabasPGA.eps}}
\subfigure[]{
\includegraphics[width=6cm]{./Figures/Part_Hazard/medianGmfTabasPGA.eps}}
\caption{Intra-event uncorrelated (a), correlated (b), and median ground motion fields.}
\label{gmfs}
\end{center}
\end{figure}
\begin{comment}
