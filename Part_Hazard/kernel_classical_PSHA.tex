...
OpenQuake generates Stochastic Event Sets using the Inverse Trasform Sampling technique, probably the simplest and commonest methodology used to randomly sample probability distribution starting from its cumulative form. 
%
% ------------------------------------------------------------------------------
