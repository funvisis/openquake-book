...
To complete the Seismic Source System definition  the the required seismic source models must be defined. A Seismic Source Model is defined as a collection of seismic sources. Four source typologies can be currently defined:
\begin{itemize}
\item Area
\item Point
\item Simple Fault
